...
export interface AllItems {
    en: {
        name: string; // name en
        type: string;
        typeAdditions?: string; // subtype
        rarity: number;
        text: string; //description en
        coast?: string;
    ...
    ru: {
        name: string; // name ru
        text: string; //description ru
        nic?: string; // better name ru
        typeAdditions?: string;
        attunement?: string // настройка на предмет
    }
}
